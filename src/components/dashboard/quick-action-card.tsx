...
const variantStyles = {
  ...
  report:
    "hover:bg-violet-50 dark:hover:bg-violet-950/20 hover:border-violet-300 dark:hover:border-violet-700",
};
...
export function QuickActionCard({
  ...
  return (
    <Button
      ...
      onClick={onClick}
      className={cn(
        "h-24 flex-col gap-3 group transition-all duration-100",
        variantStyles[variant],
        className
      )}
    >
      <div className={cn("h-5 w-5 transition-colors", iconStyles[variant])}>
        {icon}
      </div>
